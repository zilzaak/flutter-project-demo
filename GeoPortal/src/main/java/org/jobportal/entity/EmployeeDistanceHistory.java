...
@NamedStoredProcedureQuery(
        ...
        parameters = {
                ...
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "distance_from_office", type = String.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "outside_of_office", type = String.class),
